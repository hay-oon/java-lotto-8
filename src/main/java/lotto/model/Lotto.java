...
public class Lotto {
    ...
    private static final String NUMBER_SIZE_ERROR_MESSAGE = "로또 번호는 " + LOTTO_NUMBER_SIZE + "개여야 합니다.";
    private static final String NUMBER_RANGE_ERROR_MESSAGE = "로또 번호는 " + LOTTO_NUMBER_MIN + "~" + LOTTO_NUMBER_MAX + " 사이의 숫자여야 합니다.";
    private static final String NUMBER_DUPLICATE_ERROR_MESSAGE = "로또 번호는 " + LOTTO_NUMBER_SIZE + "개의 중복되지 않는 숫자여야 합니다.";
