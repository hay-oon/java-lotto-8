...
public class WinningNumber {
    ...
    private static final String WINNING_NUMBERS_DUPLICATE_ERROR_MESSAGE =
            "[ERROR] 당첨 번호는 " + WINNING_NUMBERS_SIZE + "개의 중복되지 않는 숫자여야 합니다.";
    private static final String BONUS_NUMBER_RANGE_ERROR_MESSAGE =
            "[ERROR] 보너스 번호는 " + WINNING_NUMBER_MIN + "~" + WINNING_NUMBER_MAX + " 사이의 숫자여야 합니다.";
    private static final String DUPLICATE_NUMBER_ERROR_MESSAGE = "[ERROR] 보너스 번호는 당첨번호와 중복될 수 없습니다.";
