...
class WinningNumberTest {
    ...
    void 당첨_번호가_6개가_아니면_예외가_발생한다() {
        assertThatThrownBy(() -> new WinningNumber(List.of(1, 2, 3, 4, 5), 7))
    ...
    void 당첨_번호가_범위를_벗어나면_예외가_발생한다() {
        assertThatThrownBy(() -> new WinningNumber(List.of(0, 1, 2, 3, 4, 5), 7))
                .isInstanceOf(IllegalArgumentException.class);

        assertThatThrownBy(() -> new WinningNumber(List.of(1, 2, 3, 4, 5, 46), 7))
                .isInstanceOf(IllegalArgumentException.class);
    }
